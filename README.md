...
│   ├── songs.routes.js       # Endpoints de canciones y favoritos
│   └── health.routes.js      # Health check
├── controllers/
│   ├── songs.controller.js   # Lógica de request/response para canciones
│   └── health.controller.js  # Health check
├── services/
│   ├── songs.service.js      # Queries Prisma para canciones
│   └── favorites.service.js  # Queries Prisma para favoritos
├── validations/
│   └── songs.validation.js   # Validación manual de POST/PUT
├── middlewares/
...
prisma/
├── schema.prisma             # Modelos de datos (Song, FavoriteSong)
├── seed.js                   # Datos iniciales (30 canciones)
